...
ctypes.windll.kernel32.SetConsoleTitleW("Chiv | .gg/RealBoosts")

activity = discord.Activity(type=discord.ActivityType.watching, name="Chiv | .gg/RealBoosts")
...
@bot.event
async def on_ready():
    activity = discord.Game(name=".gg/RealBoosts", type=2)
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=" .gg/RealBoosts "))
    print(f"            Chiv leaked Boosts Bot")
    print(f"                 .gg/RealBoosts")
